...
public class ClientApp {
	...
	public static void main(String[] args) throws Exception {
		...
		// load a CCP
		Path networkConfigPath = Paths.get("/home/usadadiyavimalg/eclipse-workspace/fabric-samples/test-network/organizations/peerOrganizations/org1.example.com/connection-org1.yaml");
